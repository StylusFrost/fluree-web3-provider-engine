...
export default class JsonRpcEngineMiddlewareSubprovider extends Subprovider {
  private _constructorFn: any
  middleware: any
  ...
  public setEngine(engine) {
    ...
    const blockTracker = engine.blockTracker
  ...
  public handleRequest(req, provEngNext, provEngEnd) {
    const res = { id: req.id }
